...
interface ExactWorkingStripeFormProps {
  selectedPlan: string;
  email: string;
  userId: string;
...
function PaymentForm({ selectedPlan, onSuccess, onError }: ExactWorkingStripeFormProps) {
...
export default function ExactWorkingStripeForm({ selectedPlan, email, userId, onSuccess, onError }: ExactWorkingStripeFormProps) {
  return (
